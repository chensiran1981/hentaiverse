...
var Warrior = function() {
	...
	this.onFight = function(page) {
		...
		function buff(battle,parameters) {
			...
			function arcane() {
				return parameters.keepArcaneFocus && battle.buffs.effect(GDT.ArcaneFocus) == 0 && battle.commit(GDT.ArcaneFocus);
			}
